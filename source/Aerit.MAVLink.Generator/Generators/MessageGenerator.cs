...
namespace Aerit.MAVLink.Generator
{
	...
	public static class MessageGenerator
	{
		public static string Run(string ns, MessageDefinition message, StringBuilder builder)
		{
			...
			builder.AppendLine("        {");
			builder.AppendLine("            var buffer = MemoryPool<byte>.Shared.Rent(V2.Packet.MaxLength);");
			builder.AppendLine();
			builder.AppendLine("            var span = buffer.Memory.Span;");
			builder.AppendLine();
			builder.AppendLine($"            var payload = span.Slice(10, {name}.MAVLinkMessageLength);");
			...
			builder.AppendLine();
			builder.AppendLine("            span[0] = (byte)Magic.V2;");
			builder.AppendLine("            span[1] = (byte)length;");
			builder.AppendLine("            span[2] = 0x00;");
			builder.AppendLine("            span[3] = 0x00;");
			builder.AppendLine("            span[4] = 0x00;");
			builder.AppendLine("            span[5] = systemId;");
			builder.AppendLine("            span[6] = componentId;");
			builder.AppendLine();
			builder.AppendLine($"            var messageID = {name}.MAVLinkMessageId;");
			builder.AppendLine("            span[7] = (byte)messageID;");
			builder.AppendLine("            span[8] = (byte)(messageID >> 8);");
			builder.AppendLine("            span[9] = (byte)(messageID >> 16);");
			builder.AppendLine();
			builder.AppendLine($"            span[length + 10] = {name}.MAVLinkMessageCRCExtra;");
			builder.AppendLine();
